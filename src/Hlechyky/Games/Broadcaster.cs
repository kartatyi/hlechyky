    ...
    ILogger<Broadcaster> log) : IOutbox
{
    ...
    /// останній. <see cref="DjSays"/> сюди не потрапляє: його вміє лише RadioEngine. Балачка столу
    /// (<see cref="TableSaid"/>, <see cref="TableHistory"/>) не склеюється: кожна репліка — окрема.
    /// </summary>
